function giveValues(item){
  ...
  if (item === "wood"){
    ...
    return [[width/1.5 - 350, height - 35, realSize/4], [width/1.5 - 650, height - 35, realSize/4], [width/1.5 - 500, height - 280, realSize/4], [width/1.5 - 500, height - 500, realSize/4]];// right pig, left pig, top pig
  }
}